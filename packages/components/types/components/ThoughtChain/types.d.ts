...
export type DefaultThoughtChainItemProps = RequiredDependency<
  ThoughtChainItemBase,
  'isCanExpand' | 'thinkContent'
>;

export type ThoughtChainItemProps<T = DefaultThoughtChainItemProps> = Pick<
  ThoughtChainItemBase,
  | 'hideTitle'
  | 'isMarkdown'
  | 'typing'
