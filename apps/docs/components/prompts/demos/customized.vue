...
<template>
  <div style="display: flex; flex-direction: column; gap: 12px;">
    <Prompts
      title="🐵 提示集组件标题" :items="items" wrap :style="{ width: '300px', padding: '12px', borderRadius: '8px', background: 'linear-gradient(to bottom right, rgba(237, 43, 114, 0.9), rgba(223, 67, 62, 0.9)' }"
